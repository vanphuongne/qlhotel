                            ...
                            while($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)){
                                    ...
                                    echo'<td>
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <form action="../ProcessDB/updateNhanVien.php" method="post">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select class="form-control" id="input-luong'.$i.'" name="txtQToan" >' ?>
                                                        <?php 
                                                            render('Select MaL,QToan from LUONG',$row['QToan']);
                                                        ?>
                                                        <?php echo' 
                                                        </select>
                                                    </div>
                                    ...
                                    echo '<td>
                                        ...
                                        <div class="modal-dialog ">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="../ProcessDB/deletenhanvien.php?idKH='.$row['MaNV'].'" type="button" class="btn btn-primary">Xóa</a>
                                            </div>
                                            </div>
                                        </div>
                                        </div> 
