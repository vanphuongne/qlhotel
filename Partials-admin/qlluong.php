    ...
    while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) {
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <h5 class="modal-title" id="exampleModalLabel'.$i.'">Cập nhật lương</h5>
              ...
              <form action="../ProcessDB/updateKhachHang.php" method="post">
                       <div class="form-group row">
                        <label for="inputIDNV" class="col-sm-3 col-form-label">Mã Lương</label>
                        <div class="col-sm-9">
                        <input type="text" class="form-control" id="inputMaL" value="'.$row['MaL'].'" name="txtMaKH" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputHoTenNhanVien" class="col-sm-3 col-form-label">Quyết toán</label>
                        <div class="col-sm-9">
                        <input type="text" class="form-control" id="inputQToan" value="'.$row['QToan'].'" name="txtHoTenKH">
                        </div>
                    </div>
        ...
        <div class="modal fade" id="ConfrimDeleteEmployee'.$i.'" tabindex="-1" aria-labelledby="exampleModalLabel'.$i.'" aria-hidden="true">
          <div class="modal-dialog ">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel'.$i.'">Xóa Lương</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <div class="modal-body">
                <h6>Bạn có muốn xóa Lương này ?</h6>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Huỷ</button>
                <a href="../ProcessDB/deleteKhachHang.php?idKH='.$row['MaL'].'" type="button" class="btn btn-primary">Xóa</a>
              </div>
            </div>
          </div>
        </div> 
